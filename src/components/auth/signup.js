...
class Signup extends React.Component{
  ...
  handleBirthday = e => {
    let correctForm = e.target.value.split('-').reverse().join('-');
    this.setState({ [e.target.name] : correctForm});
  }
  ...
  render (){
    return(
        ...
        <form onSubmit={this.handleSubmit}>
            ...
            <label>Username 
                <input type='text' placeholder='Enter your username' name='username' required onChange={this.handleChange}/>
            </label><br/>
            ...
            <Show condition={this.context.signupError}>
              <p>Error while signing up, try another username or choose a date between 1900 and current date!</p>
            </Show>
